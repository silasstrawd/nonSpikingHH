...
- Model Specific Code: (e.g. code to sweep over inhibitory inputs to all nodes in Ausborn 2018 model) - see Template.m
  - This type of code:
    - Initializes an input class of parameters
    - Makes changes to the default values as necessary
    - Calls the solveNonSpikingFunction on the inputClass
